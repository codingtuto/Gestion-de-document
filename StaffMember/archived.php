                    ...
                    <div class="table-responsive table-bordered">
                        ...
                        <?php 
                              ...
                              ?>
                                ...
                                <tr>
                                    <td><img src="../Administrator/img/iconfinder_7_docs_document_file_data_google_suits_2109135.png" width="25px" height="25px" > <?php echo $FileName;?></td>
                                    <td><?php echo floor($Size / 1000) . ' KB';?></td>
                                    <td><?php echo $FullName;?></td>
                                    <td><?php echo $TimeUpload;?></td>

                                         <td><a href="<?php echo $FilePath;?>" download><img src="../Administrator/img/698930-icon-97-folder-download-128.png" width="30px" height="30px"  title="Download File" title="Download File"></a></td>
