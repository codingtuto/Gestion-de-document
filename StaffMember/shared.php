                        ...
                        <table id="home_table" class="display" cellspacing="0" width="100%">
                          ...
                          <tbody>
                             <?php 
                                ...
                                require_once("../config/connection/access_db.php");
                                $z = $conn->query("SELECT * FROM personal_file WHERE StaffID = '$StaffID'") or die (mysqli_error($conn));
                             ...
                             ?>
                                <tr>
                                    ...
                                    <td><img src="../Administrator/img/Documents_folder_share_folder_shared-128.png" class="shared" width="30px" height="30px"  title="Shared File" id-data="<?php echo $row['PersonalFileID']; ?>"></td>
                                </tr>
                                <?php } ?>
                            </tbody>
                        </table>
