...
$query = $conn->query("SELECT * FROM  account WHERE Username = '$username' AND AccountType = 'Staff' AND Status = '1'")or die($conn->error());
           ...
           $count = $query->num_rows;
			  ...
			  {	
               ...
               echo '<div class="alert alert-warning alert-dismissible fade show" role="alert">
                ...
                header('Refresh: 1;url=/File_Management_System_2020/index.php');
			  } 
			  else
			  {
              ...
              if (!empty($_SERVER["HTTP_CLIENT_IP"]))
               ...
               echo '<div class="alert alert-success alert-dismissible fade show" role="alert">
                     ...
                     header('Refresh: 1;url=/File_Management_System_2020/StaffMember/home.php');
