...
if (isset($_REQUEST['SenderID'])) {
  ...
  while ($row = $result->fetch_assoc()) {
    ...
    $fullname = ucwords($row['FirstName'].' '.$row['MiddleName'].'. '.$row['LastName']);
     ...
     if ($row['AccountType'] == 'Staff' && $row['SenderID'] == $SenderID ) {
         ...
         echo '
          ...
          echo '
            <div class="incoming_msg">
              <div class="incoming_msg_img"><img src="../Administrator/'.substr($ImageURL,3).'" alt="image" width="40" height="40" style="border-radius: 50% 50%">  </div>
