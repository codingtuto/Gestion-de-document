            ...
            <div class="row">
                <div class="col">
                    <fieldset class="scheduler-border">
                        <legend class="scheduler-border">Job Positon</legend>
                        <form action="../controllers/jobposition_process.php" method="POST">
                         <div class="col-6">
                            </div>
                                <div class="col-12">
                                 ...
                                 <div class="col-12">
                                    <div class="form-group">
                                        <textarea type="text" class="form-control" name="Description" rows="3" cols="3"  placeholder="Job Description" autocomplete="off" required=""></textarea> 
                                    </div>
                                </div>
                               <div class="col-12">
                                    <div class="form-group">
                                       <button type="submit" class="btn btn-primary float-right" name="addjob">Add Job</button>
                                    </div>
                                </div>
                        </form>
                    </fieldset>
                ...
                <div class="col-7">
                    <fieldset class="scheduler-border">
                        <legend class="scheduler-border">Job Position Records</legend>

                        <div class="table-responsive table-bordered">
                            <table id="job_table" class="display" cellspacing="0" width="100%">
                                <thead>
                                    <tr>
                                        <th>Position</th>
                                        <th>Description</th>
    ...
    <script>
        $(document).ready(function() {
            $('#job_table').DataTable({
                ...
                "ajax": "../controllers/fetchjobposition_process.php",
