    ...
    <div class="container"><br>
      ...
      <!--       <h1 class="display-6" align="center">for RM-CARES</h1> -->
            ...
            <div class="row">
                        ...
                        <form action="#" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="col-12">
                                    <div class="form-group">
                                        <input type="text" name="FolderName" class="form-control" placeholder="create folder name" required="" >
                                    </div>
                                </div>
                          
                                <div class="col-12">
                                    <div class="form-group">
                                        <input type="text" name="Type" class="form-control" placeholder="create Type" required="" >
                                    </div>
                                </div>
                             <div class="col-12">
                            <div class="form-group">
                             <select class="form-control" class="form-control" name="StaffID" autocomplete="off">
                              <option selected="true" disabled="disabled">Select Staff</option>
                               ...
                               <div class="col-12">
                                    <div class="form-group">
                                       <button type="submit" class="btn btn-primary float-right"  name="savefolder">Add Folder</button>
                                    </div>
                                </div>
                        </form>
                    </fieldset>
                ...
                <div class="col-8">
                    <fieldset class="scheduler-border">
                        <legend class="scheduler-border">Folder Records</legend>

                        <div class="table-responsive table-bordered">
                            <table id="folder_table" class="display" cellspacing="0" width="100%">
                                <thead>
                                    <tr>
                                        <th>Folder Name</th>
    ...
    <script>
        $(document).ready(function() {
            $('#folder_table').DataTable({
                ...
                "ajax": "../controllers/fetchfolder_process.php",
