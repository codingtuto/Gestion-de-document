...
<head>
    ...
    <script>
        function submitchat2() {
            ...
            var RecievedID = form1.RecievedID.value;
                    ...
                    <div class="messaging">
                        <div class="inbox_msg">
                            <div class="inbox_people">
                              ...
                              <?php
                              $rx = $conn->query("SELECT MAX(a.id) as id,FirstName,MiddleName,LastName,ImageURL,Message,Datetime_created,login_time,status FROM history_log a  INNER JOIN chat b ON a.id  = b.ChatID INNER JOIN staff c ON a.id  = c.StaffID  WHERE c.StaffID != '".$StaffID."'  group by a.id DESC") or die (mysqli_error());
                                 while($row = $rx->fetch_array()){
                                     ...
                                     if($status == 'Online'){
                                            $status =  "<img src='../img/circle-n-carpet-cleaning-upland-green-dot-corporation-others-png-clip-art-thumbnail.png' height='20px' width='20px'>";
                                       }else{
                                             $status =  "<img src='../img/circle-red-circle-png-clip-art-thumbnail.png' height='15px' width='15px'>";
                                         }

                                    ?>
                                        <div class="chat_people">

                                            <div class="chat_img"> <img src="../image_upload/<?php echo $ImageURL;?>" alt="sunil" width="40" height="40" style="border-radius: 50% 50%"> </div>
                                            <div class="chat_ib">
                            ...
                            <div class="mesgs">
                                <div class="msg_history" id='scrollable'>
                                    <!---chat--->
                                    <div id="chatlogs2">
                                        <img src="../img/Spinner-1.5s-165px.svg" style="width:60px;height:60px!important">LOADING PLEASE WAIT...
                                    </div>
                                    <!---end chat--->
                                </div>
                                <div class="type_msg">
