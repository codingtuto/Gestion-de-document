                                  ...
                                  <div class="form-group">
                                   <select name="variable"  class="form-control" required="">
                                      <option selected="true" disabled="disabled"> &larr; Select a folder &rarr;</option>  
                                          <?php
                                           require_once("../config/connection/access_db.php");
                                             $query = $conn->query("SELECT * FROM  folder order by FolderID ASC") or die (mysqli_error($conn));
                    ...
                    <fieldset class="scheduler-border">
                        ...
                        <div class="table-responsive table-bordered">
                            ...
                            <?php 
                               error_reporting(0);
                                require_once("../config/connection/access_db.php");
                                $sql = $conn->query("SELECT  * FROM personal_file WHERE StaffID = '$StaffID'") or die ($conn->error());
    ...
    <script>
        $(document).ready(function() {
            $('#personal_table').DataTable({
                ...
                "ajax": "../controllers/fetchpersonalfile_process.php",
