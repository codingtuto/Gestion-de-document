            ...
            <div class="row">
                <div class="col">
                    <fieldset class="scheduler-border">
                        <legend class="scheduler-border">Division</legend>
                        <form action="../controllers/division_process.php" method="POST">
                         <div class="col-6">
                            </div>
                                <div class="col-12">
                                    <div class="form-group">
                                        <input type="text" class="form-control" name="DivisionName" placeholder="Division Name" autocomplete="off" required="">
                                    </div>
                                </div>
                                 <div class="col-12">
                                    <div class="form-group">
                                        <textarea type="text" class="form-control" name="DivisionAccronym" rows="3" cols="3"  placeholder="Division Acronym" autocomplete="off" required=""></textarea> 
                                    </div>
                                </div>
                               <div class="col-12">
                                    <div class="form-group">
                                       <button type="submit" class="btn btn-primary float-right" name="adddiv">Add Division</button>
                                    </div>
                                </div>
                        </form>
                    </fieldset>
                ...
                <div class="col-7">
                    <fieldset class="scheduler-border">
                        <legend class="scheduler-border">Division Records</legend>

                        <div class="table-responsive table-bordered">
                            <table id="division_table" class="display" cellspacing="0" width="100%">
                                <thead>
                                    <tr>
                                        <th>Division Name</th>
    ...
    <script>
        $(document).ready(function() {
            $('#division_table').DataTable({
                ...
                "ajax": "../controllers/fetchdivision_process.php",
